...
def main():
    ...
    midi_path =  str(Path('/home/tony/viMusic/transformer/data/midi/examples'))
    data_path = str(Path('/home/tony/viMusic/transformer/data/cached'))
    ...
    if mode == 'random':
        ...
        for i in range(num_outputs):
            ...
            pred, full = learn.predict(empty_item, n_words=n_words, temperatures=(note_temp, dur_temp), min_bars=12, top_k=top_k, top_p=0.8)
