...
def main(_):
  ...
  tf.compat.v1.logging.info('Saving images and melodies to: %s', rlt.output_dir)

  tf.compat.v1.logging.info('Training...')
  rlt.train(num_steps=FLAGS.training_steps,
            exploration_period=FLAGS.exploration_steps)

  tf.compat.v1.logging.info('Finished training. Saving output figures and composition.')
  ...
  tf.compat.v1.logging.info('Calculating music theory metric stats for 1000 '
                  'compositions.')
