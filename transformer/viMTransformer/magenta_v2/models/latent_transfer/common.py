...
def _load_celeba(data_path, postfix):
  ...
  with tf.io.gfile.GFile(os.path.join(data_path, 'train' + postfix), 'rb') as f:
    train_data = np.load(f)
  with tf.io.gfile.GFile(os.path.join(data_path, 'eval' + postfix), 'rb') as f:
    eval_data = np.load(f)
  with tf.io.gfile.GFile(os.path.join(data_path, 'test' + postfix), 'rb') as f:
    test_data = np.load(f)
  with tf.io.gfile.GFile(os.path.join(data_path, 'attr_train.npy'), 'rb') as f:
    attr_train = np.load(f)
  with tf.io.gfile.GFile(os.path.join(data_path, 'attr_eval.npy'), 'rb') as f:
    attr_eval = np.load(f)
  with tf.io.gfile.GFile(os.path.join(data_path, 'attr_test.npy'), 'rb') as f:
    attr_test = np.load(f)
