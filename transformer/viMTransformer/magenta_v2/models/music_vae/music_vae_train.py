...
def _trial_summary(hparams, examples_path, output_dir):
  ...
  examples_path_summary = tf.compat.v1.summary.text(
  ...
  hparam_summary = tf.compat.v1.summary.text(
...
def train(train_dir,
  ...
  with tf.Graph().as_default():
    with tf.device(tf.compat.v1.train.replica_device_setter(
      ...
      hooks.append(tf.estimator.LoggingTensorHook(logging_dict, every_n_iter=100))
      if num_steps:
        hooks.append(tf.estimator.StopAtStepHook(last_step=num_steps))
