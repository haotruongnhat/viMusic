...
class ViMusicRnnSequenceGenerator(sequence_generator.BaseSequenceGenerator):
    ...
    def _generate(self, input_sequence, generator_options):
        ...
        args['note_density_control_signal'] = 6
        ...
        while vimusic.num_steps < total_steps:
            ...
            len(vimusic) + rnn_steps_to_gen, vimusic, **args)
        ...
        #TODO: How to define CHORD_SYMBOL of annotation back to notes??\\
        #since sequence_proto_to_midi_file does not read CHORD_SYMBOL from NoteSequence, needs to find a way to apply this.
...
num_outputs=1):
    ...
    primer_pitches = [100, 100, 100, 100, 100]
    primer_velocities = [100, 100, 100, 100, 100]
    ...
    for i in range(num_outputs):
        ...
        #apply chords from text annotations to notes
