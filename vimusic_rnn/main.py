...
#train_vimusic_rnn('pop_dataset',training_steps = 12000)
generate_melody('pop_dataset', duration_in_seconds=20,temperature=1.0, steps_per_iteration=1,beam_size=2, branch_factor=2)
