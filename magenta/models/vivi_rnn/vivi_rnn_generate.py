...
"""Generate melodies from a trained checkpoint of an vivi RNN model."""
...
from magenta.models.vivi_rnn import vivi_rnn_sequence_generator
...
def run_with_flags(generator):
  ...
  Args:
    generator: The ViviRnnSequenceGenerator to use for generation.
  """
...
def main(unused_argv):
  ...
  if bundle:
    ...
    config = vivi_rnn_model.default_configs[config_id]
  ...
  generator = vivi_rnn_sequence_generator.ViviRnnSequenceGenerator(
      model=vivi_rnn_model.ViviRnnModel(config),
